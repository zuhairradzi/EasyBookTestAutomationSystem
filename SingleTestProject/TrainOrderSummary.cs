...
namespace SingleTestProject
{
    class TrainOrderSummary
    {
        ...
        public void ProductName()
        {
            try
            {
                var Div1 = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/table/tbody/tr/td/table[1]/tbody/tr[2]/td[1]"));
        ...
        public void OrderNo()
        {
            try
            {
                var OrderNo = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/table/tbody/tr/td/table[1]/tbody/tr[2]/td[1]/strong[1]/span"));
        ...
        public void PurchaseDate()
        {
            try
            {
               ...
               //Console.WriteLine(Cluster1);
                ...
                Console.WriteLine();
                //Console.WriteLine("Back Trim : " + BackTrim);
                Console.WriteLine();
        ...
        public void DepartPlace()
        {
            try
            {
                var DepartPlace = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/table/tbody/tr/td/table[2]/tbody/tr[3]/td/table[2]/tbody/tr[2]/td[2]"));
        ...
        public void ArrivePlace()
        {
            try
            {
                var ArrivePlace = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/table/tbody/tr/td/table[2]/tbody/tr[3]/td/table[2]/tbody/tr[3]/td[2]"));
        ...
        public void DepartTime()
        {
            try
            {
                var DepartTime = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/table/tbody/tr/td/table[2]/tbody/tr[3]/td/table[2]/tbody/tr[5]/td[2]"));
        ...
        public void Company()
        {
            try
            {
                var Company = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/table/tbody/tr/td/table[2]/tbody/tr[3]/td/table[2]/tbody/tr[4]/td[2]"));
        ...
        public void PassengerName()
        {
            try
            {
                var PassengerName = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/table/tbody/tr/td/table[2]/tbody/tr[3]/td/table[2]/tbody/tr[9]/td[2]"));
        ...
        public void Server()
        {
            try
            {
                var ServPlat = driver.FindElement(By.XPath("//*[@id=\"print-content\"]/div[3]"));
