...
namespace ETASSandbox
{
    class OrderSummarySandbox
    {
        ...
        string OrderNo, Div1, DepartPlace,
        ...
        {
            string url =
                "https://www.easybook.com/en-my/payment/paymentresult?guid=CR22f1e5001d034b7685&source=PaypalEC_MYR&status=completed";
        ...
        public void GetDiv1()
        {
            try
            {
                ...
                string DivOne = DivEl.Text.ToString().Trim();
                Console.WriteLine();
        ...
        public void GetPurchaseDate()
        {
            try
            {
                var Div1Elem = driver.FindElement(By.XPath(Div1));
